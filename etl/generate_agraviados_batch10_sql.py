...
OUT_TX = Path("sql/inserts/transaccional/110_agraviados_batch10_parcial.sql")
OUT_TX_CHUNKS_DIR = Path("sql/inserts/transaccional/chunks_110_b10")
OUT_PENDING = Path("docs/pendientes_carga_batch110_b4_tmp.md")
