...
OUT_TX = Path("sql/inserts/transaccional/110_agraviados_batch26_parcial.sql")
OUT_TX_CHUNKS_DIR = Path("sql/inserts/transaccional/chunks_110_b26")
OUT_PENDING = Path("docs/pendientes_carga_batch330_b4_tmp.md")
...
def main():
    ...
    pending_lines = [
        ...
        "- Siguiente accion sugerida: generar `110_agraviados_batch27_parcial.sql` empezando en `START_INDEX = " + str(end_idx) + "`.",
        "",
    ]
