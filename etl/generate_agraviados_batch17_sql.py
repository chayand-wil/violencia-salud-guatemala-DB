...
OUT_TX = Path("sql/inserts/transaccional/110_agraviados_batch17_parcial.sql")
OUT_TX_CHUNKS_DIR = Path("sql/inserts/transaccional/chunks_110_b17")
OUT_PENDING = Path("docs/pendientes_carga_batch170_b4_tmp.md")
...
def main():
    ...
    pending_lines = [
        ...
        "- Siguiente accion sugerida: generar `109_pnc_victimas_batch2_parcial.sql` empezando en `START_INDEX = 16000`.",
        "",
