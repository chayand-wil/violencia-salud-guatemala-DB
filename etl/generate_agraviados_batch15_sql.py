...
OUT_TX = Path("sql/inserts/transaccional/110_agraviados_batch15_parcial.sql")
OUT_TX_CHUNKS_DIR = Path("sql/inserts/transaccional/chunks_110_b15")
OUT_PENDING = Path("docs/pendientes_carga_batch150_b4_tmp.md")
