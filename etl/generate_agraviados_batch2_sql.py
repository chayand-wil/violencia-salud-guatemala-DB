...
OUT_TX = Path("sql/inserts/transaccional/110_agraviados_batch2_parcial.sql")
OUT_TX_CHUNKS_DIR = Path("sql/inserts/transaccional/chunks_110_b2")
OUT_PENDING = Path("docs/pendientes_carga_batch110_tmp.md")
