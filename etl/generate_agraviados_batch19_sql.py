...
OUT_TX = Path("sql/inserts/transaccional/110_agraviados_batch19_parcial.sql")
OUT_TX_CHUNKS_DIR = Path("sql/inserts/transaccional/chunks_110_b19")
OUT_PENDING = Path("docs/pendientes_carga_batch190_b4_tmp.md")
