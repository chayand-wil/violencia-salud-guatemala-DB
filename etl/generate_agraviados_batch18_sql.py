...
OUT_TX = Path("sql/inserts/transaccional/110_agraviados_batch18_parcial.sql")
OUT_TX_CHUNKS_DIR = Path("sql/inserts/transaccional/chunks_110_b18")
OUT_PENDING = Path("docs/pendientes_carga_batch180_b4_tmp.md")
...
def main():
    ...
    pending_lines = [
        ...
        "- Siguiente accion sugerida: generar `109_pnc_victimas_batch2_parcial.sql` empezando en `START_INDEX = 17000`.",
        "",
        ...
        "- Siguiente accion sugerida: generar `110_agraviados_batch2_parcial.sql` empezando en `START_INDEX = " + str(end_idx) + "`.",
        "",
    ]
