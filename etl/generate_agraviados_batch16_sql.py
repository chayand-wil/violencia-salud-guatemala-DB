...
OUT_TX = Path("sql/inserts/transaccional/110_agraviados_batch16_parcial.sql")
OUT_TX_CHUNKS_DIR = Path("sql/inserts/transaccional/chunks_110_b16")
OUT_PENDING = Path("docs/pendientes_carga_batch160_b4_tmp.md")
