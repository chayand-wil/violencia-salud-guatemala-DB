...
OUT_TX = Path("sql/inserts/transaccional/110_agraviados_batch30_parcial.sql")
OUT_TX_CHUNKS_DIR = Path("sql/inserts/transaccional/chunks_110_b30")
OUT_PENDING = Path("docs/pendientes_carga_batch410_b5_tmp.md")
