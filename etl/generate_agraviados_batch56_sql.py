...
OUT_TX = Path("sql/inserts/transaccional/110_agraviados_batch56_parcial.sql")
OUT_TX_CHUNKS_DIR = Path("sql/inserts/transaccional/chunks_110_b56")
...
def main():
    ...
    pending_lines = [
        ...
        "- Siguiente accion sugerida: generar `110_agraviados_batch56_parcial.sql` empezando en `START_INDEX = " + str(end_idx) + "`.",
        "",
    ]
