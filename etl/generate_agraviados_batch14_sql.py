...
OUT_TX = Path("sql/inserts/transaccional/110_agraviados_batch14_parcial.sql")
OUT_TX_CHUNKS_DIR = Path("sql/inserts/transaccional/chunks_110_b14")
OUT_PENDING = Path("docs/pendientes_carga_batch140_b4_tmp.md")
