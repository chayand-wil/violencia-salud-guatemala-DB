...
OUT_TX = Path("sql/inserts/transaccional/110_agraviados_batch58_parcial.sql")
OUT_TX_CHUNKS_DIR = Path("sql/inserts/transaccional/chunks_110_b58")
...
def main():
    ...
    pending_lines = [
        ...
        "- Siguiente accion sugerida: generar `110_agraviados_batch58_parcial.sql` empezando en `START_INDEX = " + str(end_idx) + "`.",
        "",
    ]
