...
OUT_TX = Path("sql/inserts/transaccional/110_agraviados_batch13_parcial.sql")
OUT_TX_CHUNKS_DIR = Path("sql/inserts/transaccional/chunks_110_b13")
OUT_PENDING = Path("docs/pendientes_carga_batch130_b4_tmp.md")
