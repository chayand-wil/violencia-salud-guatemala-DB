...
OUT_TX = Path("sql/inserts/transaccional/110_agraviados_batch24_parcial.sql")
OUT_TX_CHUNKS_DIR = Path("sql/inserts/transaccional/chunks_110_b24")
OUT_PENDING = Path("docs/pendientes_carga_batch290_b4_tmp.md")
...
def main():
    ...
    pending_lines = [
        ...
        "- Siguiente accion sugerida: generar `110_agraviados_batch25_parcial.sql` empezando en `START_INDEX = " + str(end_idx) + "`.",
        "",
    ]
