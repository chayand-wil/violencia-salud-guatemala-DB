...
- Rango cargado en parcial: 2001 a 3000
- Rango pendiente: 3001 a 444513
- Chunks generados para ejecucion segura: 4 (directorio: sql/inserts/transaccional/chunks_110_b3)
- Siguiente accion sugerida: generar `110_agraviados_batch2_parcial.sql` empezando en `START_INDEX = 3000`.
