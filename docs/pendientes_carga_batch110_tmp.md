...
- Rango cargado en parcial: 1001 a 2000
- Rango pendiente: 2001 a 444513
- Chunks generados para ejecucion segura: 4 (directorio: sql/inserts/transaccional/chunks_110_b2)
- Siguiente accion sugerida: generar `110_agraviados_batch2_parcial.sql` empezando en `START_INDEX = 2000`.
